...
export const CustomNewCardForm = {
  name: 'NewCardForm',
  render: () => <Board data={data} editable components={{NewCardForm}} />,
  parameters: {docs: {description: {story: 'Pass a custom new card form component to add card'}}}
}
