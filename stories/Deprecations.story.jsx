...
export default {title: 'Deprecation warnings'}

export const Version22Warnings = {
  name: 'v2.2 warnings',
  render: () => <Board
          data={data}
          editable
  ...
  parameters: {docs: {description: {story: 'Example of legacy props: addCardLink, customCardLayout, customLaneHeader, newLaneTemplate, and newCardTemplate'}}}
}
